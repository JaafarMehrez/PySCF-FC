...
def main():
    ...
    mol = pyscf.M(
        atom='O',
        unit='angstrom',
        basis={'O': parse_gaussian.load('O-aVDZ-EMSL.gbs', 'O')},
        charge=0,
        spin=2,
        verbose=9,
        symmetry=True,
