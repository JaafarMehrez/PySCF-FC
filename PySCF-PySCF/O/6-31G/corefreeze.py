...
def main():
    ...
    mol = pyscf.M(
        atom='O',
        unit='angstrom',
        basis={'O': parse_gaussian.load('O-6-31G-EMSL.gbs', 'O')},
        charge=0,
        spin=2,
        verbose=9,
        symmetry=True,
    ...
    eri_a  = ao2mo.restore(1,ao2mo.incore.general(eri,(mo_coeff_a, mo_coeff_a, mo_coeff_a, mo_coeff_a),compact=False),nmo)
    eri_b  = ao2mo.restore(1,ao2mo.incore.general(eri,(mo_coeff_b, mo_coeff_b, mo_coeff_b, mo_coeff_b),compact=False),nmo)
    eri_ab = ao2mo.restore(1,ao2mo.incore.general(eri,(mo_coeff_a, mo_coeff_a, mo_coeff_b, mo_coeff_b),compact=False),nmo)
    ...
    eria_4fold  = ao2mo.restore(4, eri_a, nmo_active)
    erib_4fold  = ao2mo.restore(4, eri_b, nmo_active)
    eriab_4fold = ao2mo.restore(4, eri_ab, nmo_active)
    ...
    from_integrals_uhf(filename, h1e_a, h1e_b, eria_4fold, erib_4fold, eriab_4fold, nmo_active, nelec_active, nuc + constant, 0, orbsym_active, tol=1e-18, float_format='% 0.20E')
